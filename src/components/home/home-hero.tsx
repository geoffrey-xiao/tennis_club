...
export function HomeHero() {
  return (
    <section className="relative overflow-hidden bg-[#062b23] text-white">
      <div
        className="absolute inset-0 bg-cover bg-[70%_center] opacity-80 md:bg-center"
        style={{ backgroundImage: "url('/images/tennis-hero.png')" }}
        aria-hidden="true"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-[#062b23] via-[#062b23]/86 to-[#062b23]/12" />
      <div className="absolute inset-0 bg-gradient-to-t from-[#062b23]/30 via-transparent to-transparent" />
      <div className="relative mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:min-h-[520px] md:grid-cols-[0.92fr_1.08fr] md:items-center lg:py-20">
        ...
        <div className="relative hidden min-h-80 md:block md:min-h-[420px] lg:min-h-[440px]">
          <div className="absolute inset-8 rounded-lg border-2 border-white/12" />
          <div className="absolute right-4 top-12 text-right text-6xl font-black italic leading-[0.9] text-white/12 sm:text-7xl">
            GAME
            <br />
            SET
            <br />
